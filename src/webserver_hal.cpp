...
void webserver_init(void){
  ...
  webserver_hal.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send_P(200, "text/html", index_html, processor);
  });
  webserver_hal.on("/temperature", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send_P(200, "text/plain", retTemp().c_str());
  });
  webserver_hal.on("/humidity", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send_P(200, "text/plain", retHum().c_str());
  });
  webserver_hal.on("/pressure", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send_P(200, "text/plain", retPress().c_str());
  });
  webserver_hal.on("/gas", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send_P(200, "text/plain", retGas().c_str());
  });
  webserver_hal.on("/altitude", HTTP_GET, [](AsyncWebServerRequest *request){
